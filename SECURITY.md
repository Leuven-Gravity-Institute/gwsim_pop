...
We will support the latest stable release of `gwsim_pop`.
...
If you discover a security vulnerability in `gwsim_pop`,
please report it using **GitHub's private vulnerability reporting feature**:

<!-- prettier-ignore-start -->

1. Go to the [Security](https://github.com/Leuven-Gravity-Institute/gwsim_pop/security) tab of this repository
...
Thank you for helping make `gwsim_pop` better and safer!
